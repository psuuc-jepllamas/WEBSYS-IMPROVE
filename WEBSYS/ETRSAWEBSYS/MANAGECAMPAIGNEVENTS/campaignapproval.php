...
if (isset($_GET['id'])) {
  ...
  $sql = "SELECT * FROM thumbnails WHERE id = $id"; // Add condition to fetch specific thumbnail
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    <div class='p-2 mb-4 bg-body-tertiary rounded-3'>
      <div class='container py-5'>
        ...
        <div class='row'>
          <div class='col-md-6'>
            <img class='p-5 img-fluid' src='$imagePath' alt='Thumbnail Image' height='500' width='500'/>
          </div>
          <div class='col-md-6'>
            <p class='fs-5'><b>Title:</b> $thumbname</p>
            <p class='fs-5'><b>Campus:</b> $campus</p>
            <p class='fs-5'><b>Description:</b> $description</p>
            <p class='fs-5'><b>Created At:</b> $createdAt</p>
            <p class='fs-5'><b>Expiration Date:</b> $expiration</p>
  ...
  <input type='hidden' name='thumbname' value='$thumbname'>
...
?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
        <button class="btn btn-danger" type="button" id="confirmRemove">Confirm Removal</button>
      </div>
    </div>
  </div>
</div>
