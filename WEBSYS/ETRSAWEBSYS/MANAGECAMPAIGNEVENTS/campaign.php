...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class='card shadow-sm'>
            <img src='" . $imagePath . "' class='bd-placeholder-img card-img-top' width='100%' height='225' role='img' alt='Thumbnail'>
            <div class='card-body'>
                <p class='card-text'><b>Title:</b> " . $row["thumbname"] . "</p>
                <p class='card-text'><small><b>Campus:</b> " . $row["campus"] . "</small></p>
